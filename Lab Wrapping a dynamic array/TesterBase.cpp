...
void TesterBase::OutputFooter()
{
	...
	{
		m_output << "    <div class='result-success'>" << m_subtest_totalPasses << " out of " << m_subtest_totalTests << " passed</div>" << endl;
	}
	else
	{
		m_output << "    <div class='result-failure '>" << m_subtest_totalPasses << " out of " << m_subtest_totalTests << " passed</div>" << endl;
	}
