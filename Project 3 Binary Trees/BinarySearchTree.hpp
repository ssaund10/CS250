...
public:
	...
	*/
	void Delete(const TK& key)
	{
		...
		//Sherrod binary trees data structures and algorithms for game developers//
...
private:
	...
	*/
	...
	{
		if (ptrCurrent->ptrRight) //if ptr right exists
		{
			GetMax(ptrCurrent->ptrRight); //pass ptr right until it doesn't exist
		}
		else
		{
	...
	*/
	...
	{
		//return max(GetHeight(ptrCurrent->ptrLeft), GetHeight(ptrCurrent->ptrRight)) + 1
